...
const { ensureAdmin, ensureCorrectUserOrAdmin } = require('../middleware/auth.js');
...
router.get('/:id', ensureCorrectUserOrAdmin, function(req, res, next) {
...
/* Delete a user by id */
router.delete('/:id', ensureCorrectUserOrAdmin, function(req, res) {
  var user = users[req.params.id];
